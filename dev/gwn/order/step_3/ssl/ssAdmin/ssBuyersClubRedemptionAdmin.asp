...
Dim i
	...
	ReDim paryCustomValues(5)
	
	pstrTableName = "ssBuyersClubRedemptions"
	pstrDisplayField = "ssBuyersClubRedemptionPoints"
	pstrTableSortField = "ssBuyersClubRedemptionID"
	...
	paryCustomValues(0) = Array("Redemption ID", "ssBuyersClubRedemptionID", "", enDisplayType_hiddenDisplay, "4", "", enDatatype_number, False, "", "")
	paryCustomValues(1) = Array("Customer", "ssBuyersClubRedemptionCustID", "", enDisplayType_select, "4", "SELECT custID, custLastName + ', ' + custFirstName FROM sfCustomers Order By custLastName, custFirstName", enDatatype_number, False, "", "")

	paryCustomValues(2) = Array("Points", "ssBuyersClubRedemptionPoints", "", enDisplayType_textbox, "50", "", enDatatype_number, False, "", "This is the template page which will be used in place of the default page.")
	paryCustomValues(3) = Array("Certificate ID", "ssBuyersClubRedemptionCertificateID", "", enDisplayType_textbox, "50", "", enDatatype_number, False, "", "This is the template page which will be used in place of the default page.")
	paryCustomValues(4) = Array("Notes", "ssBuyersClubRedemptionNotes", "", enDisplayType_textarea, "5", "", enDatatype_string, False, "", "This is the template page which will be used in place of the default page.")

	paryCustomValues(5) = Array("Date Created", "ssBuyersClubRedemptionDate", "", enDisplayType_textbox_WithDateSelect, "20", "", enDatatype_date, False, "", "")
...
'**********************************************************
	...
	mstrPageTitle = "Buyer's Club Points Redemption Administration"
...
Sub WriteFormOpener
%>
<form id="frmData" name="frmData" onsubmit="return ValidInput(this);" method="post" action="ssBuyersClubRedemptionAdmin.asp">
