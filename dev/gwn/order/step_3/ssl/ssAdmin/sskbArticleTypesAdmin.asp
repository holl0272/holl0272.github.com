...
Dim i
	...
	pstrTableName = "kbArticleTypes"
	pstrDisplayField = "kbArticleTypeName"
	pstrTableSortField = "kbArticleTypeName"
	...
	paryCustomValues(0) = Array("ID", "kbArticleTypeID", "", enDisplayType_hidden, "4", "", enDatatype_number, False, "", "")
	paryCustomValues(1) = Array("Article Type", "kbArticleTypeName", "", enDisplayType_textbox, "50", "", enDatatype_string, True, "", "")
...
'**********************************************************
	...
	mstrPageTitle = "kb Article Type Administration"
...
Sub WriteFormOpener
%>
<form id="frmData" name="frmData" onsubmit="return ValidInput(this);" method="post" action="sskbArticleTypesAdmin.asp">
