...
Dim menuIndex
	...
	pstrPageTitle = "Sandshot Content Management System - Breed Administration"
	pstrVersion = "1.00.001b"
	
	plngFixedContentType = enContentType_Breeds	'hardcoded to set filter to automatically display only Breed types
...
Sub WriteFormOpener
%>
<form id="frmData" name="frmData" onsubmit="return ValidInput(this);" method="post" action="ssCMS_UserType3Admin.asp">
