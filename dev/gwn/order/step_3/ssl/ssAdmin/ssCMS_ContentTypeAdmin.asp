...
Dim i
	...
	pstrKeyFieldName = "contentTypeID"
	pstrKeyFieldIsNumeric = True
	pstrExportTemplateDirectory = "-"	'Note: this must end in a /, use - to not display export capability
	pstrDisplayField = "contentTypeName"
	pstrTableSortField = "contentTypeDisplayOrder"
	pstrTableSortOrder = "Asc"
	pstrPageTitle = "Sandshot Content Management System - Content Type Administration"
	pstrPageVersion = "1.00.001b"
	pstrURL = "ssCMS_ContentTypeAdmin.asp"
	...
	paryCustomValues(0) = Array("ID", "contentTypeID", "", enDisplayType_hiddenDisplay, "4", "", enDatatype_number, False, "", "")
	paryCustomValues(1) = Array("Name", "contentTypeName", "", enDisplayType_textbox, "50", "", enDatatype_string, True, "", "Reference name. For internal use only.")
	paryCustomValues(2) = Array("Display Name", "contentTypeDisplayName", "", enDisplayType_textbox, "50", "", enDatatype_string, False, "", "Title to use for the page and for the link.")
	paryCustomValues(3) = Array("contentTypeURL", "contentTypeURL", "", enDisplayType_textbox, "50", "", enDatatype_string, False, "", "The url to display in the site map. If this is left blank the title will be used as in title.htm")
	paryCustomValues(4) = Array("Description", "contentTypeDescription", "", enDisplayType_textbox_WithHTMLSelect, "50", "", enDatatype_string, False, "", "Optional HTML fragment to display at the top of the custom manufacturer page. If left blank the manufacturer name will be used.")
	paryCustomValues(5) = Array("Display in Site Map", "contentTypeDisplayInSiteMap", "", enDisplayType_checkbox, "20", "", enDatatype_number, True, "", "")
	paryCustomValues(6) = Array("Sort Order", "contentTypeDisplayOrder", "", enDisplayType_textbox, "4", "", enDatatype_number, True, "", "")
...
'**********************************************************
    ...
    With mclsItem
		...
		mstrssAddonVersion = .PageVersion
...
Dim pbytPricingLevelID
	...
	Select Case ary(lngPos)(enCustomField_FieldName)
		Case "contentTypeURL":
			...
			Response.Write "<a href=""ssCMS_GenericContentAdmin.asp?selFilter1=8"">Customize this page display</a>"
		Case "PricingLevelID":
        %>
