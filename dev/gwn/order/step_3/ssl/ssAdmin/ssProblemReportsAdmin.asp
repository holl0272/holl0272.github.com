...
Dim i
	...
	ReDim paryCustomValues(10)
	
	pstrTableName = "problemReports"
	pstrDisplayField = "problemReportID"
	pstrTableSortField = "dateOpened"
	pstrTableSortOrder = "Desc"
	...
	paryCustomValues(0) = Array("Report ID", "problemReportID", "", enDisplayType_hidden, "4", "", enDatatype_string, False, "", "")
	paryCustomValues(1) = Array("Email", "custEmail", "", enDisplayType_textbox, "50", "", enDatatype_string, True, "", "")
	paryCustomValues(2) = Array("Name", "custName", "", enDisplayType_textbox, "50", "", enDatatype_string, False, "", "")
	paryCustomValues(3) = Array("Customer", "custID", "", enDisplayType_select, "4", "SELECT custID, custLastName + ', ' + custFirstName As custName FROM sfCustomers Order By custLastName", enDatatype_string, False, "", "")
	paryCustomValues(4) = Array("Problem Description", "problemDescription", "", enDisplayType_textarea_WithHTMLSelect, "15", "", enDatatype_string, True, "", "")
	paryCustomValues(5) = Array("Problem Resolution", "problemResolution", "", enDisplayType_textarea_WithHTMLSelect, "15", "", enDatatype_string, False, "", "")
	paryCustomValues(6) = Array("Date Opened", "dateOpened", "", enDisplayType_textbox_WithDateSelect, "50", "", enDatatype_date, True, "", "")
	paryCustomValues(7) = Array("Date Modified", "dateModified", "", enDisplayType_textbox_WithDateSelect, "50", "", enDatatype_date, False, "", "")
	paryCustomValues(8) = Array("Date Closed", "dateClosed", "", enDisplayType_textbox_WithDateSelect, "50", "", enDatatype_date, True, "", "")
	paryCustomValues(9) = Array("Product", "ProductID", "", enDisplayType_select, "4", "SELECT prodID, prodName FROM sfProducts Order By prodName", enDatatype_string, False, "", "")
	paryCustomValues(10) = Array("kb Article", "kbArticleID", "", enDisplayType_select, "4", "SELECT kbArticleID, kbTitle FROM kbArticles Order By kbTitle", enDatatype_string, False, "", "")
...
'**********************************************************
	...
	mstrPageTitle = "Problem Report Administration"
    ...
    With mclsItem
		...
		Select Case mstrAction
			Case "New", "Update"
				.Update
				If Request.Form("sendEmail) = "1" Then
...
If Len(mclsItem.Message) > 0 Then Response.Write "<p><a href=""../../ssDebuggingConsole.asp?reset_cmsPageFragments=1"">Apply Changes To Site</a></p>"
%>
...
Sub WriteFormOpener
%>
<form id="frmData" name="frmData" onsubmit="return ValidInput(this);" method="post" action="ssProblemReportsAdmin.asp">
...
<table class="tbl" width="100%" cellpadding="3" cellspacing="0" border="1" rules="none" id="tblFooter">
  <tr>
    <td>&nbsp;</td>
  <td><input type="checkbox" name="sendEmail" id="sendEmail" value="1"><label for="sendEmail">Check to send email to customer</label></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>
...
Dim pstrsqlWhere
	...
	For i = 0 To UBound(maryCustomValues)
		If maryCustomValues(i)(enCustomField_DisplayType) = enDisplayType_select Then
			...
			'Added to force filter to mfg
			If i = 1 Then
				If Len(pstrSelFilter) = 0 And Len(Request.Form) = 0 Then pstrSelFilter = 3
			End If
		ElseIf maryCustomValues(i)(enCustomField_FieldName) = "contentContentType" Then
			pstrSelFilter = maryCustomValues(i)(enCustomField_FieldValue)
		Else
			pstrSelFilter = ""
		End If
