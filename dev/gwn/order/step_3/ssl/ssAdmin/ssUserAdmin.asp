...
'********************************************************************************
'*   User Admin Manager for StoreFront 5.0                                      *
...
Dim i
	...
	pstrTableName = "ssUsers"
	pstrDisplayField = "userName"
	pstrTableSortField = "userName"
	...
	paryCustomValues(0) = Array("ssUserID", "ssUserID", "", enDisplayType_hidden, "4", "", enDatatype_number, False, "", "ID, hidden field")
	paryCustomValues(1) = Array("User Name", "userName", "", enDisplayType_textbox, "20", "", enDatatype_string, True, "", "")
	paryCustomValues(2) = Array("Password", "userPass",   "", enDisplayType_textbox, "10", "", enDatatype_string, False, "")
	paryCustomValues(3) = Array("Initials", "userInitials", "", enDisplayType_textbox, "10", "", enDatatype_string, True, "")
	paryCustomValues(4) = Array("Is Active", "isActive", "", enDisplayType_checkbox, "10", "", enDatatype_number, True, "")
	paryCustomValues(5) = Array("Failed Login Attempts", "failedLoginAttempts", "", enDisplayType_textbox, "20", "", enDatatype_number, True, "")
	paryCustomValues(6) = Array("Last Access", "LastLogin", "", enDisplayType_textbox_WithDateSelect, "20", "", enDatatype_date, True, "")
	paryCustomValues(7) = Array("Last Edited", "dateEdited", "", enDisplayType_textbox_WithDateSelect, "20", "", enDatatype_date, False, "")

	'specific permission categories
	paryCustomValues(8) = Array("Administrator?", "isAdmin", "", enDisplayType_checkbox, "20", "", enDatatype_number, False, "")
	paryCustomValues(9) = Array("View Orders", "Orders_View", "", enDisplayType_checkbox, "20", "", enDatatype_number, False, "")
	paryCustomValues(10) = Array("View Credit Card", "Orders_ViewCC", "", enDisplayType_checkbox, "20", "", enDatatype_number, False, "")
	paryCustomValues(11) = Array("Edit Orders", "Orders_Edit", "", enDisplayType_checkbox, "20", "", enDatatype_number, False, "")
	paryCustomValues(12) = Array("Delete Orders", "Orders_Delete", "", enDisplayType_checkbox, "20", "", enDatatype_number, False, "")
	paryCustomValues(13) = Array("View Reports", "Orders_Report", "", enDisplayType_checkbox, "20", "", enDatatype_number, False, "")
	paryCustomValues(14) = Array("Edit Products", "Products_Edit", "", enDisplayType_checkbox, "20", "", enDatatype_number, False, "")
...
'**********************************************************
	...
	mstrPageTitle = "User Administration"
	mstrssAddonVersion = "1.00.001"

	Call CheckLoginStatus(True)
...
Sub WriteFormOpener
%>
<form id="frmData" name="frmData" onsubmit="return ValidInput(this);" method="post" action="ssUserAdmin.asp">
