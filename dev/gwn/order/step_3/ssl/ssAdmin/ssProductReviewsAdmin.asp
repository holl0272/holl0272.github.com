...
Dim i
	...
	paryCustomValues(1) = Array("Author", "contentAuthorID", "", enDisplayType_textbox, "5", "", enDatatype_string, False, "", "Customer who wrote this review. This will only be present if the customer was logged in at the time of writing the review.")
	'paryCustomValues(2) = Array("Content Type", "contentContentType", "", enDisplayType_select, "4", "SELECT contentTypeID, contentTypeName FROM contentTypes Order By contentTypeName", enDatatype_number, False, "", "")
	...
	'paryCustomValues(3) = Array("Product", "contentReferenceID",   "", enDisplayType_textbox, "5", "Select sfProductID, prodName FROM sfProducts Order By prodName", enDatatype_number, True, "")
	paryCustomValues(3) = Array("Product", "contentReferenceID",   "", enDisplayType_select, "5", "Select sfProductID, prodName FROM sfProducts Order By prodName", enDatatype_number, True, "")
	paryCustomValues(4) = Array("Approved For Display", "contentApprovedForDisplay", "", enDisplayType_checkbox, "20", "", enDatatype_number, True, "", "")
	paryCustomValues(5) = Array("Review", "contentContent", "", enDisplayType_textarea, "6", "", enDatatype_string, False, "", "")
	paryCustomValues(6) = Array("Author", "contentAuthorName", "", enDisplayType_textbox, "20", "", enDatatype_string, True, "", "Name as entered")
	paryCustomValues(7) = Array("Author's Email", "contentAuthorEmail", "", enDisplayType_textbox, "50", "", enDatatype_string, True, "", "Email as entered")
	paryCustomValues(8) = Array("Display Email", "contentAuthorShowEmail", "", enDisplayType_checkbox, "20", "", enDatatype_number, False, "", "Display email in the product review")
	paryCustomValues(9) = Array("Rating", "contentAuthorRating",   "", enDisplayType_textbox, "20", "", enDatatype_number, True, "", "The numeric value of the rating.")
	paryCustomValues(10) = Array("Date Created", "contentDateCreated", "", enDisplayType_textbox_WithDateSelect, "20", "", enDatatype_date, False, "", "")
	paryCustomValues(11) = Array("Date Modified", "contentDateModified", "", enDisplayType_textbox_WithDateSelect, "20", "", enDatatype_date, False, "", "")
...
'**********************************************************
	...
	mstrPageTitle = "Product Review Administration"
...
Sub WriteFormOpener
%>
<form id="frmData" name="frmData" onsubmit="return ValidInput(this);" method="post" action="ssProductReviewsAdmin.asp">
