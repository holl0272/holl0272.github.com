...
'********************************************************************************
'*   Tax Rate Manager for StoreFront 5.0                                        *
'*   Release Version:	2.00.001		                                        *
'*   Release Date:		August 29, 2005											*
'*   Revision Date:		August 29, 2005											*
'*                                                                              *
'*   Release Notes:                                                             *
'*                                                                              *
'*   2.00.001 (August 29, 2005)													*
'*   - Initial Release															*
'*                                                                              *
...
Dim i
	...
	pstrDisplayField = "PostalCode"
	pstrTableSortField = "PostalCode"
	...
	paryCustomValues(0) = Array("TaxRateID", "TaxRateID", "", enDisplayType_hidden, "4", "", enDatatype_number, False)
	paryCustomValues(1) = Array("City", "City", "", enDisplayType_textbox, "20", "", enDatatype_string, True)
	paryCustomValues(2) = Array("County", "County",   "", enDisplayType_textbox, "20", "", enDatatype_string, True)
	paryCustomValues(3) = Array("Locale Abbr", "LocaleAbbr", "", enDisplayType_textbox, "3", "", enDatatype_string, True)
	paryCustomValues(4) = Array("Postal Code", "PostalCode", "", enDisplayType_textbox, "20", "", enDatatype_string, True)
	paryCustomValues(5) = Array("Tax Rate", "TaxRate", "", enDisplayType_textbox, "20", "", enDatatype_number, True)
...
'**********************************************************
	...
	mstrPageTitle = "Local Tax Rate Administration"
...
<table id="tblMainPage" class="tbl" style="border-collapse: collapse" bordercolor="#111111" width="100%" cellpadding="1" cellspacing="0" border="0" rules="none">
  <tr>
	...
	<th width="90%" align=right><span class="pagetitle2"><%= mstrPageTitle %></span>&nbsp;<input class="butn" type=button value="?" onclick="OpenHelp('ssHelpFiles/TaxRateMgr/help_TaxRateMgr.htm')" id="btnHelp" name="btnHelp" title="Release Version <%= mstrssAddonVersion %>"></th>
  </tr>
  <tr>
...
Sub WriteFormOpener
%>
<form id="frmData" name="frmData" onsubmit="return ValidInput(this);" method="post" action="ssTaxRateAdmin.asp">
