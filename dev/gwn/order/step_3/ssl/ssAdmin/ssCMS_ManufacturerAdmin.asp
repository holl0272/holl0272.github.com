...
Dim i
	...
	'Note: contentContentType is hardcoded to 3 to set filter to automatically display only manufacturer types
	plngFixedContentType = 3
	...
	'paryCustomValues(1) = Array("Content Type", "contentContentType", "", enDisplayType_select, "4", "SELECT contentTypeID, contentTypeName FROM contentTypes Where contentTypeID=3 Order By contentTypeName", enDatatype_number, False, "", "")
	paryCustomValues(1) = Array("Content Type", "contentContentType", plngFixedContentType, enDisplayType_hidden, "4", "", enDatatype_number, True, "", "")
