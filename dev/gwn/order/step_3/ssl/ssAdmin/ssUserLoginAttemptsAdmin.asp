...
Dim i
	...
	pstrTableName = "ssUserLog"
	pstrDisplayField = "ssUserLogUserID"
	pstrTableSortField = "ssUserLogInDate"
	...
	paryCustomValues(0) = Array("ID", "ssUserLogID", "", enDisplayType_hidden, "4", "", enDatatype_number, False, "", "ID, hidden field")
	paryCustomValues(1) = Array("Result", "ssUserLogInResult", "", enDisplayType_textbox, "40", "", enDatatype_string, True, "", "")
	paryCustomValues(2) = Array("User", "ssUserLogUserID", "", enDisplayType_textbox, "20", "", enDatatype_string, True, "", "")
	paryCustomValues(3) = Array("Date", "ssUserLogInDate", "", enDisplayType_textbox_WithDateSelect, "20", "", enDatatype_date, True, "")
	paryCustomValues(4) = Array("IP Address", "ssUserLogIP",   "", enDisplayType_textbox, "20", "", enDatatype_string, True, "")
...
'**********************************************************
	...
	mstrPageTitle = "User Login Attempts Administration"
...
Sub WriteFormOpener
%>
<form id="frmData" name="frmData" onsubmit="return ValidInput(this);" method="post" action="ssUserLoginAttemptsAdmin.asp">
