...
Dim pstrOrderBy
    ...
    Response.Write "<div name='divSummary' style='height:200; overflow:auto;'>"
	...
	if pRS.RecordCount > 0 then
		...
		for i=1 to prs.RecordCount
			...
			pstrURL = "sszbsCarrierAdmin.asp?Action=View&ID=" & pRS("shipID")
			...
			if cBool(pRS("shipIsActive")) then
        		Response.Write "<TD>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='sszbsCarrierAdmin.asp?Action=Deactivate&ID=" & pRS("shipID") & _
        		...
        		Response.Write "<TD>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='sszbsCarrierAdmin.asp?Action=Activate&ID=" & pRS("shipID") & _
...
dim pstrOrderBy
	...
	mstrOrderBy = Request.QueryString("OrderBy")
	If len(mstrOrderBy) = 0 Then mstrOrderBy = Request.Form("OrderBy")
...
With mclsCarrier    
    Select Case mAction
        Case "New", "Update"
            If .Update then
				If .LoadAll Then .Find Request.Form("ID")
			Else
				.LoadAll
				.LoadFromRequest
			End If
        ...
        Case "View"
         ...
         Case "Activate", "Deactivate"
			.Activate Request.QueryString("ID"), mAction="Activate"
            If .LoadAll Then .Find Request.QueryString("ID")
       Case Else
            .LoadAll
    End Select
...
<FORM action='sszbsCarrierAdmin.asp' id=frmData name=frmData onsubmit='return ValidInput(this);' method=post>
...
<colgroup align="left">
  ...
  <tr>
	<td colspan="2" align=center><%= .OutputMessage %></span></td>
  </tr>
      <tr>
        <TD class="label"><LABEL id=lblMETHODS for=METHODS>Method:</LABEL></TD>
        <TD>
			<INPUT id=METHODS name=METHODS Value="<%= .METHODS %>" maxlength=65 size=65>&nbsp;&nbsp;
			<% If len(.ID) > 0 Then Response.Write "<a href='sszbsShippingRatesAdmin.asp?ShipMethodFilter=" & .ID & "'>Configure " & .METHODS & " Rate Table</a>" %>
        </TD>
      </tr>
      <tr>
        <TD class="label"><LABEL id=lblCODE for=CODE>Code:</LABEL></TD>
        <TD><INPUT id=CODE name=CODE Value="<%= .CODE %>" maxlength=60 size=60></TD>
      </tr>
      <tr>
