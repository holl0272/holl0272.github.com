...
Dim i
	...
	pstrTableName = "kbCategories"
	pstrDisplayField = "kbCategoryName"
	pstrTableSortField = "kbCategoryID"
	...
	paryCustomValues(0) = Array("ID", "kbCategoryID", "", enDisplayType_hidden, "4", "", enDatatype_number, False, "", "")
	paryCustomValues(1) = Array("Category", "kbCategoryName", "", enDisplayType_textbox, "50", "", enDatatype_string, True, "", "")
...
'**********************************************************
	...
	mstrPageTitle = "kb Category Administration"
...
Sub WriteFormOpener
%>
<form id="frmData" name="frmData" onsubmit="return ValidInput(this);" method="post" action="sskbCategoriesAdmin.asp">
