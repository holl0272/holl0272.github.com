...
Dim i
	...
	pstrDisplayField = "vendName"
	pstrTableSortField = "vendName"
	...
	paryCustomValues(0) = Array("ID", "vendID", "", enDisplayType_hiddenDisplay, "4", "", enDatatype_number, False)
	paryCustomValues(1) = Array("Name", "vendName", "", enDisplayType_textbox, "20", "", enDatatype_string, True)
	paryCustomValues(2) = Array("Addr1", "vendAddress1", "", enDisplayType_textbox, "20", "", enDatatype_string, False)
	paryCustomValues(3) = Array("Addr2", "vendAddress2", "", enDisplayType_textbox, "20", "", enDatatype_string, False)
	paryCustomValues(4) = Array("City", "vendCity", "", enDisplayType_textbox, "20", "", enDatatype_string, True)
	paryCustomValues(5) = Array("State", "vendState", "", enDisplayType_select, "4", "SELECT loclstAbbreviation, loclstName FROM sfLocalesState WHERE loclstLocaleIsActive=1 Order By loclstName", enDatatype_string, False)
	paryCustomValues(6) = Array("Zip", "vendZip", "", enDisplayType_textbox, "20", "", enDatatype_string, False)
	paryCustomValues(7) = Array("Country", "vendCountry", "", enDisplayType_select, "4", "SELECT loclctryAbbreviation, loclctryName FROM sfLocalesCountry WHERE loclctryLocalIsActive=1 Order By loclctryName", enDatatype_string, False)
	paryCustomValues(8) = Array("Email", "vendEmail", "", enDisplayType_textbox, "20", "", enDatatype_string, False)
	paryCustomValues(9) = Array("Phone", "vendPhone", "", enDisplayType_textbox, "10", "", enDatatype_string, False)
	paryCustomValues(10) = Array("FAX", "vendFAX", "", enDisplayType_textbox, "10", "", enDatatype_string, False)
	paryCustomValues(11) = Array("Notes", "vendNotes", "", enDisplayType_textarea, "5", "", enDatatype_string, False)
	...
	'paryCustomValues(12) = Array("URL", "vendHttpAddr", "", enDisplayType_textbox, "50", "", enDatatype_string, False)
	'paryCustomValues(13) = Array("Meta title", "vendMetaTitle", "", enDisplayType_textarea, "2", "", enDatatype_string, False, "")
	'paryCustomValues(14) = Array("Meta description", "vendMetaDescription", "", enDisplayType_textarea, "5", "", enDatatype_string, False, "")
	'paryCustomValues(15) = Array("Meta keywords", "vendMetaKeywords", "", enDisplayType_textarea, "2", "", enDatatype_string, False, "")
	'paryCustomValues(16) = Array("Description", "vendDescription", "", enDisplayType_textbox_WithHTMLSelect, "20", "", enDatatype_string, False, "")
...
'**********************************************************
	...
	mstrPageTitle = "Vendor Administration"
...
Sub WriteFormOpener
%>
<form id="frmData" name="frmData" onsubmit="return ValidInput(this);" method="post" action="sfVendorsAdmin.asp">
...
<table class="tbl" width="100%" cellpadding="3" cellspacing="0" border="1" rules="none" id="tblCustom">
	...
	%>
      <tr>
        <td class="Label">&nbsp;</td>
        <td><a href="ssCMS_VendorAdmin.asp?selFilter2=<%= maryCustomValues(0)(enCustomField_FieldValue) %>">Customize this vendor's display</a></td>
      </tr>
</table>
<% 
