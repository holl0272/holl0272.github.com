...
Function getProductDetail(byVal strProdID, byVal strFieldName)

Dim pobjRS_ProductDetail
Dim pstrSQL
Dim pstrOut

	pstrSQL = "Select " & strFieldName & " From sfProducts Where prodID=" & wrapSQLValue(strProdID, False, enDatatype_string)
	Set pobjRS_ProductDetail = GetRS(pstrSQL)
	If Not pobjRS_ProductDetail.EOF Then
		pstrOut = Trim(pobjRS_ProductDetail.Fields(strFieldName).Value & "")
	End If
	Call ReleaseObject(pobjRS_ProductDetail)
	
	getProductDetail = pstrOut

End Function	'getProductDetail
...
<font color="blue" style="font-size: 14pt; font-family: Book Antiqua">Sandshot Software</font><br />
<font color="blue" style="font-size: 9pt; font-family: Book Antiqua">http://www.sandshot.net</font> 
    </th>
   </tr>
  <tr>
