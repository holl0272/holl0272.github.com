...
<xsl:if test="$needsPageBreak"><hr class="PageBreak" /></xsl:if>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr><td align="center">
<table width="99%" border="0" cellpadding="0">
  <tr> 
    <td width="47%" valign="top">
        <img src="GWN_121406.gif" alt="Your Logo" /><br />
		<p class="MerchantAddress">
        3530 W. 16th Street<br />
        INDIANAPOLIS, IN  46222<br />
        1 (877) 796-6639<br />
        <br />
        http://www.gamewearnow.com<br />
        </p>
        <p></p>
    </td>
    <td width="53%" valign="top" align="right">
        <p class="PageTitle">Packing Slip</p>
