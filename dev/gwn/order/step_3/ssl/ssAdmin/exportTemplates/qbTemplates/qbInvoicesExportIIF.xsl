...
<xsl:if test="orderPaymentMethod[.='Credit Card']"><xsl:value-of select="payCardType" /></xsl:if><xsl:if test="orderPaymentMethod[.!='Credit Card']"><xsl:value-of select="orderPaymentMethod" /></xsl:if>
-->
...
<!-- ********* USER DEFINED SETTINGS ARE FOUND IN qbAccountSettings. The settings below are specific to the Sales Receipt export. -->
      <xsl:variable name="outputType" select="'INVOICE'"/>
      <xsl:variable name="printInvoice" select="'N'"/>
...
<!-- ACCNT -->"<xsl:value-of select="$accountsReceivableName"/>"<xsl:text>,</xsl:text>
...
<!-- PONUM -->"<xsl:value-of select="orderPurchaseOrderNumber"/>"<xsl:text>,</xsl:text><!-- PO number used for invoices only, Invoice number used for sales receipts -->
...
<!-- TRNSID --><xsl:text>,</xsl:text>
<!-- TRNSTYPE -->PAYMENT<xsl:text>,</xsl:text>
<!-- DATE --><xsl:value-of select="$dateToExport"/><xsl:text>,</xsl:text>
<!-- ACCNT -->"<xsl:value-of select="$paymentsAccountName"/>"<xsl:text>,</xsl:text>
<!-- NAME -->"<xsl:apply-templates select="billingAddress"/>"<xsl:text>,</xsl:text>
<!-- CLASS --><xsl:text>,</xsl:text>
<!-- AMOUNT -->"<xsl:value-of select="format-number(number(orderGrandTotal),'###0.00')" />"<xsl:text>,</xsl:text>
<!-- DOCNUM --><xsl:value-of select="InvoiceNumber"/><xsl:text>,</xsl:text>
<!-- MEMO --><xsl:text>,</xsl:text>
<!-- CLEAR -->N<xsl:text>,</xsl:text>
<!-- TOPRINT --><xsl:text>,</xsl:text>
<!-- TOSEND --><xsl:text>,</xsl:text>
<!-- ADDR1 --><xsl:text>,</xsl:text>
<!-- ADDR2 --><xsl:text>,</xsl:text>
<!-- ADDR3 --><xsl:text>,</xsl:text>
<!-- ADDR4 --><xsl:text>,</xsl:text>
<!-- ADDR5 --><xsl:text>,</xsl:text>
<!-- DUEDATE --><xsl:text>,</xsl:text>
<!-- TERMS --><xsl:text>,</xsl:text>
<!-- PAID -->Y<xsl:text>,</xsl:text>
<!-- PAYMETH -->"<xsl:value-of select="payCardType"/>"<xsl:text>,</xsl:text>
<!-- SHIPVIA --><xsl:text>,</xsl:text>
<!-- SHIPDATE --><xsl:text>,</xsl:text>
<!-- REP --><xsl:text>,</xsl:text>
<!-- FOB --><xsl:text>,</xsl:text>
<!-- PONUM -->"<xsl:value-of select="orderID"/>"<xsl:text>,</xsl:text>
<!-- INVTITLE --><xsl:text>,</xsl:text>
<!-- INVMEMO --><xsl:text>,</xsl:text>
<!-- SADDR1 --><xsl:text>,</xsl:text>
<!-- SADDR2 --><xsl:text>,</xsl:text>
<!-- SADDR3 --><xsl:text>,</xsl:text>
<!-- SADDR4 --><xsl:text>,</xsl:text>
<!-- SADDR5 --><xsl:text>,</xsl:text>
<!-- NAMEISTAXABLE --><xsl:text>"N"</xsl:text>

<xsl:choose>
    <xsl:when test="ssGiftCertificate/RedemptionAmount[.&lt;0]">
<!-- Now for the accounts receivable with revised total due -->
SPL<xsl:text>,</xsl:text>
<!-- SPLID --><xsl:text>,</xsl:text>
<!-- TRNSTYPE -->PAYMENT<xsl:text>,</xsl:text>
<!-- DATE --><xsl:value-of select="$dateToExport"/><xsl:text>,</xsl:text>
...
<!-- NAME --><xsl:text>,</xsl:text>
<!-- CLASS --><xsl:text>,</xsl:text>
<!-- AMOUNT -->"-<xsl:value-of select="format-number(number(ssGiftCertificate/ssGCNewTotalDue),'###0.00')" />"<xsl:text>,</xsl:text>
<!-- DOCNUM -->"<xsl:value-of select="InvoiceNumber"/>"<xsl:text>,</xsl:text>
<!-- MEMO --><xsl:text>,</xsl:text>
<!-- CLEAR -->N<xsl:text>,</xsl:text>
<!-- PRICE --><xsl:text>,</xsl:text>
...
<!-- EXTRA -->
    ...
    <xsl:otherwise>
<!-- Now for the accounts receivable -->
SPL<xsl:text>,</xsl:text>
<!-- SPLID --><xsl:text>,</xsl:text>
<!-- TRNSTYPE -->PAYMENT<xsl:text>,</xsl:text>
<!-- DATE --><xsl:value-of select="$dateToExport"/><xsl:text>,</xsl:text>
