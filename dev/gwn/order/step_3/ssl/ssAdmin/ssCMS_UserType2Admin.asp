...
Dim menuIndex
	...
	pstrPageTitle = "Sandshot Content Management System - Theme Administration"
	pstrVersion = "1.00.001b"
	
	plngFixedContentType = enContentType_Themes	'hardcoded to set filter to automatically display only Theme types
...
Sub WriteFormOpener
%>
<form id="frmData" name="frmData" onsubmit="return ValidInput(this);" method="post" action="ssCMS_UserType2Admin.asp">
