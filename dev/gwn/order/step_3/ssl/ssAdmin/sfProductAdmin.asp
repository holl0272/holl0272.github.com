...
<!--#include file="ProductManager_Support/sfProductAdmin_detail_CustomTab2.asp"-->
<%
...
function body_onload()
{
	...
	//this is to initially hide each detail section
	DisplayMainSection('Detail');
...
FillCategory();
<% End If %>
<% If cblnProductCustomValues2 Then Response.Write "doCustom_Load();" & vbcrlf %>
}
...
If cblnProductCustomValues2 Then pstrTempHeaderRow = pstrTempHeaderRow & ",'Custom2'"
