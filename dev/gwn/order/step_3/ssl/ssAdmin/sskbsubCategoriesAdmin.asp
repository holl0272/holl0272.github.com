...
Dim i
	...
	pstrTableName = "kbsubCategories"
	pstrDisplayField = "kbsubCategoryName"
	pstrTableSortField = "kbsubCategoryID"
	...
	paryCustomValues(0) = Array("ID", "kbsubCategoryID", "", enDisplayType_hidden, "4", "", enDatatype_number, False, "", "")
	paryCustomValues(1) = Array("Category", "kbCategoryID", "", enDisplayType_select, "4", "SELECT kbCategoryID, kbCategoryName FROM kbCategories Order By kbCategoryName", enDatatype_number, False, "", "")
	paryCustomValues(2) = Array("Sub-Category", "kbsubCategoryName", "", enDisplayType_textbox, "50", "", enDatatype_string, True, "", "")
...
'**********************************************************
	...
	mstrPageTitle = "kb Sub-Category Administration"
...
Sub WriteFormOpener
%>
<form id="frmData" name="frmData" onsubmit="return ValidInput(this);" method="post" action="sskbsubCategoriesAdmin.asp">
