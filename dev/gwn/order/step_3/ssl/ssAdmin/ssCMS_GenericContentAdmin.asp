...
Dim i
	...
	paryCustomValues(0) = Array("contentID", "contentID", "", enDisplayType_hiddenDisplay, "4", "", enDatatype_number, False, "", "")
	...
	paryCustomValues(2) = Array("Content Reference", "contentReferenceID",   "", enDisplayType_textbox, "5", "", enDatatype_number, True, "")
	...
	paryCustomValues(6) = Array("Manufacturer text", "contentContent", "", enDisplayType_textbox_WithHTMLSelect, "4", "", enDatatype_string, False, "", "Optional HTML fragment to display at the top of the custom manufacturer page. If left blank the manufacturer name will be used.")
	paryCustomValues(7) = Array("Display Name", "contentTitle", "", enDisplayType_textbox, "50", "", enDatatype_string, True, "", "Anchor text to use for links in. If left blank the manufacturer name will be used.")
	paryCustomValues(8) = Array("META - Title", "contentPageTitle", "", enDisplayType_textbox, "50", "", enDatatype_string, False, "", "Title to use for the page and for the link. If left blank the manufacturer name will be used.")
	paryCustomValues(9) = Array("META - Description", "contentMetaDescription", "", enDisplayType_textbox, "50", "", enDatatype_string, False, "", "Description which will appear for the description meta tag. This should be kept fairly brief. If left blank the manufacturer name will be used.")
	paryCustomValues(10) = Array("META - Keywords", "contentMetaKeywords", "", enDisplayType_textbox, "50", "", enDatatype_string, False, "", "The keywords meta tag. This should be kept fairly brief. If left blank the manufacturer name will be used.")
	paryCustomValues(11) = Array("META - Author", "contentMetaAuthor", "", enDisplayType_textbox, "50", "", enDatatype_string, False, "", "The author meta tag. This should be kept fairly brief.")
	paryCustomValues(12) = Array("Custom 1", "contentMetaCustom1", "", enDisplayType_textbox, "50", "", enDatatype_string, False, "", "")
	paryCustomValues(13) = Array("Custom 2", "contentMetaCustom2", "", enDisplayType_textbox, "50", "", enDatatype_string, False, "", "")

	paryCustomValues(14) = Array("Date Created", "contentDateCreated", "", enDisplayType_textbox_WithDateSelect, "20", "", enDatatype_date, False, "", "")
	paryCustomValues(15) = Array("Date Modified", "contentDateModified", "", enDisplayType_textbox_WithDateSelect, "20", "", enDatatype_date, False, "", "")
	paryCustomValues(16) = Array("Sort Order", "contentSortOrder", "", enDisplayType_textbox, "4", "", enDatatype_number, True, "", "")
...
'**********************************************************
	...
	mstrPageTitle = "Sandshot Content Management System - Content Administration"
...
Sub WriteFormOpener
%>
<form id="frmData" name="frmData" onsubmit="return ValidInput(this);" method="post" action="ssCMS_GenericContentAdmin.asp">
...
Function CustomDisplayText(byVal lngPos, byRef ary)
	...
	Select Case ary(lngPos)(enCustomField_FieldName)
		Case "contentContentType":
			CustomDisplayText = "<a href='ssCMS_ContentTypeAdmin.asp?Action=ViewProduct&ViewID=" & ary(mclsItem.getIndexByFieldName("contentContentType"))(enCustomField_FieldValue) & "'>" & ary(lngPos)(enCustomField_DisplayText) & "</a>"
		Case Else:
