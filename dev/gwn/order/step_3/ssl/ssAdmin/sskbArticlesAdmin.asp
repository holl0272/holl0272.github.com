...
Dim i
	...
	pstrTableName = "kbArticles"
	pstrDisplayField = "kbTitle"
	pstrTableSortField = "kbTitle"
	...
	paryCustomValues(0) = Array("kbArticleID", "kbArticleID", "", enDisplayType_hidden, "4", "", enDatatype_number, False, "", "")
	paryCustomValues(1) = Array("Title", "kbTitle", "", enDisplayType_textbox, 100, "", enDatatype_string, True, "", "")
	paryCustomValues(2) = Array("Article", "kbArticle", "", enDisplayType_textarea_WithHTMLSelect, 15, "", enDatatype_string, False, "", "")
	paryCustomValues(3) = Array("Type", "kbType", "", enDisplayType_select, "4", "SELECT kbArticleTypeID, kbArticleTypeName FROM kbArticleTypes Order By kbArticleTypeName", enDatatype_string, False, "", "")
	paryCustomValues(4) = Array("Category", "kbCategory", "", enDisplayType_select, "4", "SELECT kbCategoryID, kbCategoryName FROM kbCategories Order By kbCategoryName", enDatatype_string, False, "", "")
	paryCustomValues(5) = Array("subCategory", "kbsubCategory", "", enDisplayType_select, "4", "SELECT kbsubCategoryID, kbsubCategoryName FROM kbsubCategories Order By kbsubCategoryName", enDatatype_string, False, "", "")
	paryCustomValues(6) = Array("Date Modifed", "kbDateModifed", "", enDisplayType_textbox_WithDateSelect, 20, "", enDatatype_date, True, "", "")
...
'**********************************************************
	...
	mstrPageTitle = "kb Articles Administration"
...
Sub WriteFormOpener
%>
<form id="frmData" name="frmData" onsubmit="return ValidInput(this);" method="post" action="sskbArticlesAdmin.asp">
