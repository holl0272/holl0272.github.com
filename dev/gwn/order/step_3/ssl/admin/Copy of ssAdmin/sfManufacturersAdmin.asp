...
Dim i
	...
	ReDim paryCustomValues(12)
	
	pstrTableName = "sfManufacturers"
	pstrDisplayField = "mfgName"
	pstrTableSortField = "mfgName"
	...
	paryCustomValues(0) = Array("ID", "mfgID", "", enDisplayType_hiddenDisplay, "4", "", enDatatype_number, False, "", "Customer ID, hidden field")
	paryCustomValues(1) = Array("Name", "mfgName", "", enDisplayType_textbox, "20", "", enDatatype_string, True, "", "")
	paryCustomValues(2) = Array("Address 1", "mfgAddress1", "", enDisplayType_textbox, "30", "", enDatatype_string, False, "")
	paryCustomValues(3) = Array("Address 2", "mfgAddress2", "", enDisplayType_textbox, "30", "", enDatatype_string, False, "")
	paryCustomValues(4) = Array("City", "mfgCity", "", enDisplayType_textbox, "20", "", enDatatype_string, False, "")
	paryCustomValues(5) = Array("State", "mfgState", "", enDisplayType_select, "4", "SELECT loclstAbbreviation, loclstName FROM sfLocalesState WHERE loclstLocaleIsActive=1 Order By loclstName", enDatatype_string, False, "")
	paryCustomValues(6) = Array("Zip", "mfgZip", "", enDisplayType_textbox, "20", "", enDatatype_string, False, "")
	paryCustomValues(7) = Array("Country", "mfgCountry", "", enDisplayType_select, "4", "SELECT loclctryAbbreviation, loclctryName FROM sfLocalesCountry WHERE loclctryLocalIsActive=1 Order By loclctryName", enDatatype_string, False, "")
	paryCustomValues(8) = Array("Phone", "mfgPhone", "", enDisplayType_textbox, "10", "", enDatatype_string, False, "")
	paryCustomValues(9) = Array("Email", "mfgEmail", "", enDisplayType_textbox, "50", "", enDatatype_string, True, "")
	paryCustomValues(10) = Array("FAX", "mfgFAX", "", enDisplayType_textbox, "10", "", enDatatype_string, False, "")
	paryCustomValues(11) = Array("Notes", "mfgNotes",   "", enDisplayType_textarea, "5", "", enDatatype_string, False, "")
	paryCustomValues(12) = Array("Active", "mfgIsActive",   "", enDisplayType_checkbox, "5", "", enDatatype_boolean, True, "")

	'Decided to use content manager instead
	'paryCustomValues(12) = Array("URL", "mfgHttpAdd",   "", enDisplayType_textbox, "20", "", enDatatype_string, False, "")
	'paryCustomValues(13) = Array("Meta title", "mfgMetaTitle", "", enDisplayType_textarea, "2", "", enDatatype_string, False, "")
	'paryCustomValues(14) = Array("Meta description", "mfgMetaDescription", "", enDisplayType_textarea, "5", "", enDatatype_string, False, "")
	'paryCustomValues(15) = Array("Meta keywords", "mfgMetaKeywords", "", enDisplayType_textarea, "2", "", enDatatype_string, False, "")
	'paryCustomValues(16) = Array("Description", "mfgDescription", "", enDisplayType_textbox_WithHTMLSelect, "20", "", enDatatype_string, False, "")
...
'**********************************************************
	...
	mstrPageTitle = "Manufacturer Administration"
	mstrssAddonVersion = "2.00.004"
...
Sub WriteFormOpener
%>
<form id="frmData" name="frmData" onsubmit="return ValidInput(this);" method="post" action="sfManufacturersAdmin.asp">
...
<table class="tbl" width="100%" cellpadding="3" cellspacing="0" border="1" rules="none" id="tblCustom">
	...
	%>
      <tr>
        <td class="Label">&nbsp;</td>
        <td><a href="ssCMS_ManufacturerAdmin.asp?selFilter2=<%= maryCustomValues(0)(enCustomField_FieldValue) %>">Customize this manufacturer's display</a></td>
      </tr>
</table>
<% 
