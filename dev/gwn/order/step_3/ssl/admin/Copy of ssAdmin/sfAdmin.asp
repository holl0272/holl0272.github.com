	...
	<colgroup width="75%">
      ...
      <td colspan=2>
       ...
       <TD width=40% valign=top>
          ...
          <input type="radio" value="2" name="adminShipType" id="adminShipType2" <% if .adminShipType="2" then Response.Write "checked" %>><a href="sfShippingAdmin.asp" onMouseOver='return DisplayTitle(this);' onMouseOut='ClearTitle();' title="Configure Carrier Based Rates">Real Time Rates (by weight)</a><br>
