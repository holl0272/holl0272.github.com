...
End Function	'ProcessUpdates
	...
	Dim pstrTemp
		...
		If True Then
			...
			pstrTemp = RetrieveRemoteData("sfCategoryAdminAE_v2_00_003.asp?Action=SaveChanges",mobjXMLDoc.xml,True,False)
...
'					TreeView1.Nodes.Clear()
	...
	Dim pblnResult
		...
		set mobjXMLDoc = CreateObject("MSXML2.DOMDocument")
		mobjXMLDoc.async = false
		pstrRawData = RetrieveRemoteData("sfCategoryAdminAE_v2_00_003.asp?Action=GetData","",False,True)
...
<% If cbytMode > 0 Then %>
  <TR>
    ...
    <TD align=left><INPUT id="catDescription" name="catDescription" value="" onkeyup="ChangeItem()" maxlength=50 size=50>&nbsp;<a HREF="javascript:doNothing()" onClick="ChangeItem(); return openACE(document.frmData.catDescription);" title="Edit this field with the HTML Editor"><img SRC="images/prop.bmp" BORDER=0></a>
    </TD>
  </TR>
  <TR>
...
<FORM id=frmXMLData name=frmXMLData action="sfCategoryAdminAE_v2_00_003.asp" method="post">
