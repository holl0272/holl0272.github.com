	...
	<table border="1" cellspacing="0" class="tbl">
		...
		<tr class="tblhdr">
			<th>
				...
				<xsl:attribute name="onclick">onSort('orderDetail/ProductCode', 'descending', 'text', 'imgSort_0');</xsl:attribute>
				<xsl:text>Product Code</xsl:text>
				<img src="../images/clear.gif" id="imgSort_0" border="0" align="bottom" />
			</th>
			<th>
				<xsl:attribute name="style">cursor:hand</xsl:attribute>
				<xsl:attribute name="onclick">onSort('orderDetail/ProductName', 'descending', 'text', 'imgSort_1');</xsl:attribute>
				<xsl:text>Product Name</xsl:text>
				<img src="../images/clear.gif" id="imgSort_1" border="0" align="bottom" />
			</th>
			<th>
		...
		<tbody>
			<xsl:for-each select="msxsl:node-set($productKeys)/key">
				<xsl:sort select="ProductCode" data-type="text" order="descending" />
				...
				<tr>
					<td>
						...
						<xsl:with-param name="Default" select="ProductCode" />
					...
					<td>
						<xsl:call-template name="productInfo">
						<xsl:with-param name="productUID" select="$productUID" />
						<xsl:with-param name="Default" select="ProductName" />
