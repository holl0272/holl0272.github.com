...
function RUN()
	...
	document.write("	<input type=checkbox onclick='"+oName+".setDisplayMode()' id=chkDisplayMode name=chkDisplayMode><font face=verdana size=1>&nbsp;<label for=chkDisplayMode>HTML</label> &nbsp;</font>");
	document.write("	<input type='checkbox' id=chkBreakMode"+oName+" name=chkBreakMode"+oName+"><font face=verdana size=1>&nbsp;<label for=chkBreakMode"+oName+">BR</label>&nbsp;</font>");
