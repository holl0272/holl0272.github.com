...
Dim i
	...
	pstrTableName = "sfAffiliates"
	pstrDisplayField = "affName"
	pstrTableSortField = "affID"
	...
	paryCustomValues(0) = Array("ID", "affID", "", enDisplayType_hiddenDisplay, "4", "", enDatatype_number, False, "", "Customer ID, hidden field")
	paryCustomValues(1) = Array("Code", "affName", "", enDisplayType_textbox, "20", "", enDatatype_string, True, "", "Customer last name")
	paryCustomValues(2) = Array("Name", "affCompany", "", enDisplayType_textbox, "20", "", enDatatype_string, True, "")
	paryCustomValues(3) = Array("Addr1", "affAddress1", "", enDisplayType_textbox, "30", "", enDatatype_string, False, "")
	paryCustomValues(4) = Array("Addr2", "affAddress2", "", enDisplayType_textbox, "30", "", enDatatype_string, False, "")
	paryCustomValues(5) = Array("City", "affCity", "", enDisplayType_textbox, "20", "", enDatatype_string, False, "")
	paryCustomValues(6) = Array("State", "affState", "", enDisplayType_textbox, "4", "", enDatatype_string, False, "")
	paryCustomValues(7) = Array("Zip", "affZip", "", enDisplayType_textbox, "20", "", enDatatype_string, False, "")
	paryCustomValues(8) = Array("Country", "affCountry", "", enDisplayType_select, "4", "SELECT loclctryAbbreviation, loclctryName FROM sfLocalesCountry WHERE loclctryLocalIsActive=1 Order By loclctryName", enDatatype_string, False, "")
	paryCustomValues(9) = Array("Email", "affEmail", "", enDisplayType_textbox, "50", "", enDatatype_string, True, "")
	paryCustomValues(10) = Array("Phone", "affPhone", "", enDisplayType_textbox, "10", "", enDatatype_string, False, "")
	paryCustomValues(11) = Array("FAX", "affFAX", "", enDisplayType_textbox, "10", "", enDatatype_string, False, "")
	paryCustomValues(12) = Array("Notes", "affNotes", "", enDisplayType_textarea, "5", "", enDatatype_string, False, "")
	paryCustomValues(13) = Array("URL", "affHttpAddr", "", enDisplayType_textbox, "100", "", enDatatype_string, True, "", "Customer last name")
	paryCustomValues(14) = Array("Password", "affPassword", "", enDisplayType_textbox, "10", "", enDatatype_string, False, "")
...
Sub WriteFormOpener
%>
<form id="frmData" name="frmData" onsubmit="return ValidInput(this);" method="post" action="sfAffiliatesAdmin.asp">
