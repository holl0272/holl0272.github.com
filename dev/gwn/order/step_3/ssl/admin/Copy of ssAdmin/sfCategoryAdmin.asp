...
Public Property Get rssubCategory()
	Set rssubCategory = prssubCategory
End Property
...
'On Error Resume Next
    ...
    Set prssubCategory = GetRS("Select * from sfsubCategories Order By subcatName")
...
<table class="tbl" width="95%" cellpadding="3" cellspacing="0" border="1" rules="none" id="tblFilter">
  ...
  <TR>
    ...
    <TD>
        ...
        <INPUT class='butn' id=btnDeleteSub name=btnDeleteSub type=button value='Delete sub-Category' onclick='return btnDeleteSub_onclick(this)' <% If Not(.catHasSubCategory And len(.subCatID)<>0) Then Response.Write "disabled"  %>>
