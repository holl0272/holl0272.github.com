...
Dim i
	...
	pstrDisplayField = "payCardType"
	pstrTableSortField = "payID"
	...
	paryCustomValues(0) = Array("payID", "payID", "", enDisplayType_hidden, "4", "", enDatatype_number, False, "", "Customer ID, hidden field")
	paryCustomValues(1) = Array("Customer", "payCustId", "", enDisplayType_select, "4", "SELECT custID, custLastName FROM sfCustomers Order By custLastName", enDatatype_string, False, "")
	paryCustomValues(2) = Array("payCardType", "payCardType", "", enDisplayType_select, "4", "SELECT transID, transName FROM sfTransactionTypes Where transType='Credit Card' Order By transName", enDatatype_string, True, "")
	paryCustomValues(3) = Array("payCardName", "payCardName", "", enDisplayType_textbox, "40", "", enDatatype_string, False, "")
	paryCustomValues(4) = Array("payCardNumber", "payCardNumber", "", enDisplayType_textbox, "20", "", enDatatype_string, False, "")
	paryCustomValues(5) = Array("payCardExpires", "payCardExpires", "", enDisplayType_textbox, "10", "", enDatatype_string, False, "")
...
'**********************************************************
	...
	mstrPageTitle = "Payments Administration"
...
Sub WriteFormOpener
%>
<form id="frmData" name="frmData" onsubmit="return ValidInput(this);" method="post" action="sfCPaymentsAdmin.asp">
...
Dim pbytPricingLevelID
	...
	Select Case ary(lngPos)(enCustomField_FieldName)
		...
		<%
		Case "payCardNumber":
			Response.Write writeHTMLFormElement(ary(lngPos)(enCustomField_DisplayType), ary(lngPos)(enCustomField_DisplayLength), ary(lngPos)(enCustomField_FieldName), ary(lngPos)(enCustomField_FieldName), DecryptCardNumber(ary(lngPos)(enCustomField_FieldValue), False), ary(lngPos)(enCustomField_sqlSource), "MakeDirty(this);") 
		Case Else:
