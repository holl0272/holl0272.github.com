...
Dim pobjRS
	...
	If cblnDebugPromotionManagerAddon Then
		Response.Write("<fieldset><legend>IsAvailableForUseByThisCustomer</legend>")
		Response.Write("plngCustID: " & plngCustID & "<br />")
	End If
	...
	Else
		...
		With pobjCmd
			...
			Set pobjRS = .Execute
			If cblnDebugPromotionManagerAddon Then Response.Write("pobjRS.EOF: " & pobjRS.EOF & "<br />")
			If pobjRS.EOF Then
				pblnResult = True
			Else
				If cblnDebugPromotionManagerAddon Then
					Response.Write("CountOforderID: " & pobjRS.Fields("CountOforderID").Value & "<br />")
					Response.Write("NumUsesByCustomer: " & pobjRS.Fields("NumUsesByCustomer").Value & "<br />")
				End If
	...
	If cblnDebugPromotionManagerAddon Then
		Response.Write("IsAvailableForUseByThisCustomer: " & pblnResult & "<br />")
...
Dim plngUniqueOrderItemCount
	...
	For i = 0 to plngItemCount
		...
		If UBound(aryOrderItems) >= i Then paryOrder(i,enOrder_BasePrice) = aryOrderItems(i)(enOrderItem_prodBasePrice)
