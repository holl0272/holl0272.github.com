...
'---------------------------------------------------------------------
Function zgetAttrDetails(iAttrID)
...
'**********************************************************************************************************
'
'  this file modified for Sandshot Software's Attribute Extender
'
' Function getAttrDetails(iAttrID) renamed to Function zgetAttrDetails(iAttrID)
' 
' below file included
%>
