	...
	Select Case iShipType
		...
		Case 1 
		   If iTotalPur > 0 Then
					...
					If iTotalPur > 0 Then 
		     			SQL = "SELECT valShpPurTotal, valShpAmt FROM sfValueShipping WHERE valShpPurTotal <= " & clng(FormatNumber(iTotalPur,2)) & " ORDER BY valShpPurTotal DESC" '
			        	If vDebug = 1 Then 
